...
EXAMPLE_DIRECTORIES = ['socket', 'tutorial', 'wireless', 'error-model', 'udp-client-server', 'naming', 'udp', 'matrix-topology', 'traffic-control', 'ipv6', 'tcp', 'realtime', 'routing', 'stats', 'energy']
...
INCLUDES_PYEMBED = ['/data/sigs_users/szxie/anaconda3/include/python3.7m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/data/sigs_users/szxie/anaconda3/lib/python3.7/config-3.7m-x86_64-linux-gnu', '/data/sigs_users/szxie/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
NS3_EXECUTABLE_PATH = ['/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build/src/fd-net-device', '/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build/lib', '/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build']
...
PYO = 1
PYTAG = 'cpython-37'
PYTHON = ['/data/sigs_users/szxie/anaconda3/bin/python3']
PYTHONARCHDIR = '/usr/local/lib/python3.7/site-packages'
PYTHONDIR = '/usr/local/lib/python3.7/site-packages'
PYTHON_CONFIG = ['/data/sigs_users/szxie/anaconda3/bin/python3-config']
PYTHON_VERSION = '3.7'
...
cfg_files = ['/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build/ns3/config-store-config.h', '/data/sigs_users/szxie/ReCoCo/gym_folder/ns-3-dev/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
